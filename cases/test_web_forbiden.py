...
def test_add_information(login_01):
    ...
    data ={
        "title": "小房中英环境资讯"+get_randomInt(),
        "cover": "https://digital-test-8.oss-cn-hangzhou.aliyuncs.com/expo/10015032021013100016120640620470000000000271269/ad/20211025192619861_j9d5uyp1.jpeg",
        "languageType": "ALL",
        ...
        "status": "AUDITING",
        "materialList": [{
            "thumbInfo": "https://digital-test-8.oss-cn-hangzhou.aliyuncs.com/expo/10015032021013100016120640620470000000000271269/pdf/20211025192653811_9br6bufy.pdf",
            "url": "https://digital-test-8.oss-cn-hangzhou.aliyuncs.com/expo/10015032021013100016120640620470000000000271269/pdf/20211025192653811_9br6bufy.pdf",
            "size": 120041,
...
def test_add_tickets(login_01):
    ...
    goodname="小方新增门票-免费-3种"+get_randomInt()
    data ={"goodsName": "{\"zh-cn\":\"小房呀新增门票-免费-3种\",\"en-us\":\"xfmenpiao1230211\"}",
	"ticketRights": "{\"zh-cn\":\"门票权益123\",\"en-us\":\"门票权益en\"}",
	"feeConfig": "FREE",
	"goodsPrice": None,
	"stockTotal": 100,
	"verifyConfig": "VERIFY",
	"formId": "100115012021061100016234064286799072900544729962",
	"admissionTimes": [{
		"startDate": "2021-11-26",
		"endDate": "2021-12-31",
		"startTime": "06:00",
		"endTime": "23:00"}],
	"verificationMethod": "[\"ELECTRONIC_CODE\",\"FACE_SCAN\",\"ID_CARD\"]",
	"sellStartTime": "2021-11-26",
	"sellEndTime": "2021-12-31",
	"ticketStatus": "WAIT_PUBLISH"}
    headers = {
         'Authorization': token,
        'x-access-lang': 'zh-cn',
        'x-ca-tenant-id': tenantId,
...
def test_ticket_list(login_01):
    '''门票列表+按照门票名称搜素'''
    url = host + '/api/v2/goods/tickets/page?pageNum=1&pageSize=10&goodsName=%E5%B0%8F%E6%88%BF'
    data=None
    headers = {
         'Authorization': token,
        'x-access-lang': 'zh-cn',
...
def test_ticket_detail(login_01):
    '''门票详情'''
    url = host + '/api/v2/goods/tickets/100119002021061400016236400972828164748152272019'
    data=None
    headers = {
         'Authorization': token,
        'x-access-lang': 'zh-cn',
...
def test_ticket_publish(login_01):
    ...
    data = {
	"goodsId": "100119002021112900016381669124208173730495024703",
...
def test_ticket_delete(login_01):
    ...
    url=host+"/api/v2/goods/tickets/100119002021112900016381669124208173730495024703"
    data = {}
    headers = {
         'Authorization': token,
        'x-access-lang': 'zh-cn',
